...
<center>
```{r, echo=FALSE}
pander::pander(posicao(notas$P1.presencial))
```
</center>
...
<center>
```{r, echo=FALSE}
pander::pander(posicao(notas$P1.remota))
```
</center>
...
p1 = ggplot(notas) + 
  geom_histogram(aes(x=P1.remota,
                     y=..density..), 
                 position="identity",
                 col = 1,
                 lwd = 1,
                 breaks = seq(0,10,0.5)) + 
  geom_density(aes(x=P1.remota,
                   y=..density..),
               col = 4,
               lwd = 1) + 
  ylab("Densidade") +
  xlab("") +
  ggtitle("Prova 1 - remota")+
  theme_classic() + theme(legend.position = 'none',
                          plot.title = element_text(family = "Helvetica", 
                                                    face = "bold", 
                                                    size = (20),
...
<center>
```{r, echo=FALSE}
pander::pander(posicao(notas$P2.remota))
```
</center>
...
p1 = ggplot(notas) + 
  geom_histogram(aes(x=P2.remota,
                     y=..density..), 
                 position="identity",
                 col = 1,
                 lwd = 1,
                 breaks = seq(0,10,0.5)) + 
  geom_density(aes(x=P2.remota,
                   y=..density..),
               col = 4,
               lwd = 1) + 
  ylab("Densidade") +
  xlab("") +
  ggtitle("Prova 2 - remota")+
  theme_classic() + theme(legend.position = 'none',
                          plot.title = element_text(family = "Helvetica", 
                                                    face = "bold", 
                                                    size = (20),
